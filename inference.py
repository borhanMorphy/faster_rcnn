...
class RPN(torch.nn.Module):
    ...
    def forward(self,x,threshold:float=None):
        ...
        cls,reg,selected_anchors = self.apply_threshold(cls,reg,threshold)
    ...
    def apply_threshold(self,cls:torch.Tensor,reg:torch.Tensor,threshold:float):
        ...
        return cls,reg,selected_anchors
